...
feature 'Admin adds new video' do
  scenario 'Admin successfully adds a new video' do
    ...
    attach_file "Large cover", "spec/support/uploads/hyomin1.png"
    attach_file "Small cover", "spec/support/uploads/hyomin2.png"
    ...
    expect(page).to have_selector("img[src='/uploads/hyomin1.png']")
